...
| 子目标 | R1 后 | R2 后 | R3 后 | R4 后 | R5 后 | R6 后 | R7 后 |
|--------|-------|-------|-------|-------|-------|-------|-------|
| 1. 数据完整性 | 深 | 深 | 深 | 深 | 深+ | 深+ | 深+ |
| 2. 路由正确性 | 深 | 深 | 深 | 深 | 深 | 深 | 深 |
| 3. 可访问性 | 未涉及 | 未涉及 | 中 | 中 | 中 | 中 | 中+ |
| 4. SEO/元数据 | 未涉及 | 深 | 深 | 深 | 深+ | 深+ | 深+ |
| 5. 部署链路 | 深 | 深 | 深 | 深 | 深 | 深 | 深 |
| 6. 可扩展性 | 未涉及 | 未涉及 | 深 | 深 | 深 | 深 | 深 |

> 子目标 3（可访问性）当前为"中+"：已含 skip-link（WCAG 2.4.1）、颜色对比度 AA（1.4.3）、lang/landmark/aria-label。继续做深需 focus-visible 样式（2.4.7）、屏幕阅读器实测，属正式开发阶段 a11y 打磨，不在 MVP demo 范围。
